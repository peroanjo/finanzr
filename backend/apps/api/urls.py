...
urlpatterns = [
    ...
    path("funds/<uuid:instrument_id>", views.fund_detail),
    ...
    path("stock-prices/<uuid:instrument_id>", views.stock_price_detail),
    ...
    path("fund-chart/<uuid:instrument_id>", views.fund_chart),
    path("stock-chart/<uuid:instrument_id>", views.stock_chart),
    path("crypto-chart/<uuid:instrument_id>", views.crypto_chart),
