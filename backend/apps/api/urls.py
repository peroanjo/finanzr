...
urlpatterns = [
    ...
    path("savings/accounts/<int:legacy_id>", views.savings_account),
    path("savings/history", views.savings_history),
    path(
        "savings/history/<int:legacy_id>/<str:value_date>",
        views.snapshot_detail,
        {"kind": "savings"},
    ),
    path("investments/accounts", views.investment_accounts),
    path("investments/accounts/<int:legacy_id>", views.investment_account),
    path("investments/history", views.investment_history),
    path(
        "investments/history/<int:legacy_id>/<str:value_date>",
        views.snapshot_detail,
        {"kind": "manual_investment"},
    ),
